...
@decomp.register_decomposition([torch.ops.spyre.dequantize_fp8_with_scale], spyre_decompositions)
def dequantize_fp8_with_scale_decomp(input: torch.Tensor, scale: torch.Tensor) -> torch.Tensor:
    """
